...
class WaveCustom extends StatefulWidget {
  final double size;
  ...
  @override
  State<WaveCustom> createState() => _WaveCustomState();
}

class _WaveCustomState extends State<WaveCustom> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant WaveCustom oldWidget) {
